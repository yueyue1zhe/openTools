...
$.showMPLoading = (text="加载中...",el="#mainBox")=>{
    $(el).mLoading({html:true,content:`
<div class="mloading-bar" style="margin-top: -31px; margin-left: -125px;">
    <img class="mloading-icon" src="data:image/gif;base64," data-times="1">
    <span class="mloading-text">${text}</span>
    <div class="progress"><div></div></div>
    <div id="MpAppend"></div>
</div>
`,mask:true})
}
$.showMPLoadingAppend = (text="")=>{
    $("#MpAppend").text(text);
}
$.showMPRate = (e)=>{
...
$.showMLoading = (text="加载中",el="#mainBox")=>{$(el).mLoading({text: text})};
$.hideMLoading = (el="#mainBox")=>{$(el).mLoading("hide")};