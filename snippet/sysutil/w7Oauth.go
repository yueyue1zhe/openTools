...
func GetW7Manager(appid, appSecret string) *W7Manager {
	client := req.C()
...
func (w *W7Manager) GetLoginUrl(redirectUrl string) (string, error) {
...
func (w *W7Manager) getSign(data map[string]string) string {
